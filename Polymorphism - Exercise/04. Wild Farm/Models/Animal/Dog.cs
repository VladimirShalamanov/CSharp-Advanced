namespace P04.WildFarm.Models.Animal
{
    ...
    public class Dog : Mammal
    {
        ...
        public Dog(string name, double weight, string livingRegiom)
        ...
        public override void Feed(Food food)
        {
            ...
            {
                throw new ArgumentException(String.Format(ExceptionsMesseges.InvalidFoodException, this.GetType().Name, food.GetType().Name));
            }
